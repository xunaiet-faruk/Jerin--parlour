...
const Login = () => {
    return (
        <div>
            <div className=" min-h-screen bg-cover" style={{ backgroundImage: 'url(https://i.ibb.co/6mXKZKt/image.png)' }}>
                <div className=" pt-32">
                    <div className="w-full max-w-md p-8 space-y-3 rounded-xl border backdrop-blur-3xl   font-sans mx-auto">
