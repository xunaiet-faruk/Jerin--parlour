...
export const Banner = () => {
    ...
    return (
        <div className="bg-[#Faeae3]  flex  lg:flex-row flex-col  lg:h-[700px]  items-center justify-between px-20 mx-auto max-w-screen-2xl">
            <div className="lg:w-1/2 lg:text-start text-center lg:mt-0 mt-32 space-y-3 ">
                ...
                <h1 className="font-bold text-5xl"> EVERY WOMEN</h1>

                <p className="text-[#666666] lg:pl-0 pl-6 pb-10 pt-10 w-[570px]">Jerin Beauty Salon offers the latest and highest quality services for you and all your family members. We specialize in all beauty treatments and our team is fully professional and innovative, from makeup services to hairstyling.We offer a full range of hairdressing services for men and women, eyebrow and eyelash care</p>
