...
const Testominals = () => {
    ...
    return (
        <div className="mt-44 mb-12 max-w-screen-2xl mx-auto ">    
            <div className="hero bg-cover bg-fixed  h-[400px] " style={{ backgroundImage: 'url(https://i.ibb.co/9Wqbf1g/image.png)' }}> 
                        ...
                        <div
                            ...
                            {Review?.map((each, idx) => (
                                <div key={idx} className="p-4   min-w-full md:min-w-[50%]">
                                    <div className="h-full backdrop-blur-xl  p-8 rounded-sm shadow-[0px_4px_12px_rgba(0,0,0,0.1)]">
                                        ...
                                        <p className="leading-relaxed mb-6 text-white">{each?.details}</p>
                                        <a className="inline-flex items-center">
                                            <img className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" src={user?.photoURL} alt="carousel navigate ui" />
                                            <span className="flex-grow flex flex-col pl-4">
                                                <span className="title-font font-medium text-gray-900">{each.name}</span>
                                                <span className="text-gray-500 text-sm">{each?.company}</span>
                                            </span>
                                        </a>
                                    </div>
                                </div>
